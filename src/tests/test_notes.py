...
def test_create_note(test_app: TestClient, monkeypatch: MonkeyPatch):
...
def test_create_note_invalid_json(test_app: TestClient):
...
def test_read_note(test_app: TestClient, monkeypatch: MonkeyPatch):
...
def test_read_note_incorrect_id(test_app: TestClient, monkeypatch: MonkeyPatch):
    async def mock_get(id):
        return None
...
def test_read_all_notes(test_app: TestClient, monkeypatch: MonkeyPatch):
    test_data = [
...
def test_update_note(test_app: TestClient, monkeypatch: MonkeyPatch):
...
def test_update_note_invalid(
    test_app: TestClient, monkeypatch: MonkeyPatch, id, payload, status_code
    ):
    async def mock_get(id):
        return None
...
def test_remove_note(test_app: TestClient, monkeypatch: MonkeyPatch):
...
def test_remove_note_incorrect_id(test_app: TestClient, monkeypatch: MonkeyPatch):
    async def mock_get(id):
        return None
